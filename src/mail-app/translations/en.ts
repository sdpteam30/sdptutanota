...
export default {
	...
	"keys": {
		...
		"addManagedCustomers_action": "Add Customer",
		...
		"adminManagedCustomerList_action": "Customers",
		...
		"allowExternalContentSender_action": "Always display images for sender",
		...
		"blockExternalContentSender_action": "Always block images for sender",
		"blockNewsletterBanner_action": "Hide banner for sender",
		"blue_label": "Blue",
		...
		"confirm_order_page_subtitle": "Take back control of your data",
		...
		"corrupted_msg": "This element cannot be displayed correctly.\n\nIf the error persists, please ask the sender to re-send this message.",
		...
		"create_new_account_label": "Create account",
		...
		"createFolder_action": "New Folder",
		...
		"fingerprintMismatchManual_msg": "The verification code for this contact is different from the one that you verified.",
		...
		"inboxRuleExcludedFromSpamFilter_msg": "Never send it to Spam",
		...
		"mobile_label": "Mobile",
		"mobyPhish_action": "Known Sender",
		"mobyPhish_confirm": "Known Sender",
		"mobyPhish_deny": "Deny",
		"mobyPhish_is_trusted": "Does this email seem to be from a known sender?",
		...
		"mobyPhish_trusted_once": "View Links and Attachments",
		"mobyPhish_untrust": "Undo Show Blocked Content",
		"mobyPhish_report": "Report",
		"mobyPhish_report_phishing": "Report as Phishing",
		"mobyPhish_auth_failed": "⚠️ Email Security Warning: This email failed authentication checks and may be fraudulent.",
		...
		"partnerSettings_label": "Partner settings",
		...
		"payment_page_subtitle": "Your privacy matters. No ads, no selling of data, no compromises.",
		...
		"paymentDataPayPalChangeAccount_msg": "If you would like to change the account you are connected to, please click on the PayPal button and log in again.",
		...
		"recovery_kit_page_checkbox_msg": "I understand the risks and importance of saving this code for resetting my password. Without this code my account can not be recovered.",
		...
		"searchManagedCustomers_placeholder": "Search for customers",
		...
		"showBlockedContent_action": "Show Blocked Content",
		...
		"signup_page_subtitle": "Securely encrypt your emails, calendars and contacts with Tuta.",
		...
		"tooManyScheduledMails_msg": "Allowed number of scheduled emails exceeded.",
		...
		"undoSendMail_msg": "Please note that you can undo sending an email within {time} seconds clicking send.",
		...
		"until_label": "until",
		"untitledFolder_label": "New folder",
		...
		"upgradeNeeded_msg": "You can currently only exchange emails with invoice@tutao.de because you did not complete the booking of a paid subscription during registration. You can complete the booking within 14 days of registering, otherwise your account will be deactivated.",
