...
let EncryptionAuthStatus = function(EncryptionAuthStatus$1) {
	...
	EncryptionAuthStatus$1["RSA_DESPITE_TUTACRYPT"] = "5";
...
let PublicKeyIdentifierType = function(PublicKeyIdentifierType$1) {
	...
	PublicKeyIdentifierType$1["KEY_ROTATION_ID"] = "2";
...
function asPublicKeyIdentifier(maybe) {
	if (Object.values(PublicKeyIdentifierType).includes(maybe)) return maybe;
