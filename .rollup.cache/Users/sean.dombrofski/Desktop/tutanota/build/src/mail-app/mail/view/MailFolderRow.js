...
export class MailFolderRow {
    ...
    view(vnode) {
        ...
        return m(".folder-row.flex.flex-row.mlr-button.border-radius-small.state-bg", {
            style: {
            ...
            m("button.flex.items-center.justify-end" + (editMode || !hasChildren ? ".no-hover" : ""), {
                style: {
...
//# sourceMappingURL=MailFolderRow.js.map