...
export async function showContactListEditor(contactListGroupRoot, headerText, save, addressesOnList) {
...
export async function showContactListNameEditor(name, save) {
    let nameInput = name;
    let form = () => [
        m(TextField, {
            label: "name_label",
...
class ContactListEditor {
    ...
    view() {
        ...
        else if (this.model.currentAddresses.includes(cleanMailAddress(this.newAddress)) ||
...
//# sourceMappingURL=ContactListEditor.js.map