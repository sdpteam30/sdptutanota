...
export function openPressReleaseEditor(mailboxDetails) {
    function close() {
        dialog.close();
    }
    async function send() {
        ...
        for (let recipient of recipients) {
            ...
            try {
                ...
                await model.send("0" /* MailMethod.NONE */, () => Promise.resolve(true), (_, p) => {
...
export class PressReleaseForm {
    ...
    constructor(vnode) {
        ...
        this.editor = new Editor(200, (html, _) => htmlSanitizer.sanitizeFragment(html, {
...
//# sourceMappingURL=PressReleaseEditor.js.map