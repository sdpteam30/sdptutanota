 ...
 */
export function getMergeableContacts(inputContacts) {
    ...
    while (firstContactIndex < contacts.length - 1) {
        ...
        while (secondContactIndex < contacts.length) {
            ...
            if (firstContact._id[1] !== secondContact._id[1]) {
                ...
                let overallResult = "unique" /* ContactComparisonResult.Unique */;
                ...
                for (let i = 0; i < currentMergableContacts.length; i++) {
                    ...
                    if (result === "equal" /* ContactComparisonResult.Equal */) {
                        overallResult = "equal" /* ContactComparisonResult.Equal */;
                        break; // equal is always the final result
                    }
                    else if (result === "similar" /* ContactComparisonResult.Similar */) {
                        overallResult = "similar" /* ContactComparisonResult.Similar */; // continue checking the other contacts in currentMergableContacts to see if there is an equal one
                    }
                    else {
                ...
                if (overallResult === "equal" /* ContactComparisonResult.Equal */) {
                    duplicateContacts.push(secondContact);
                    contacts.splice(secondContactIndex, 1);
                }
                else if (overallResult === "similar" /* ContactComparisonResult.Similar */) {
 ...
 */
export function mergeContacts(keptContact, eliminatedContact) {
 ...
 * Export for testing
 */
export function _compareContactsForMerge(contact1, contact2) {
    ...
    if (birthdayResult !== "unique" /* ContactComparisonResult.Unique */ &&
        (!contact1.presharedPassword || !contact2.presharedPassword || contact1.presharedPassword === contact2.presharedPassword)) {
        if ((nameResult === "equal" /* ContactComparisonResult.Equal */ || nameResult === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */) &&
            (mailResult === "equal" /* ContactComparisonResult.Equal */ || mailResult === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */) &&
            (phoneResult === "equal" /* ContactComparisonResult.Equal */ || phoneResult === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */) &&
            residualContactFieldsEqual) {
            if (birthdayResult === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */ || birthdayResult === "equal" /* ContactComparisonResult.Equal */) {
                return "equal" /* ContactComparisonResult.Equal */;
            }
            else {
                return "similar" /* ContactComparisonResult.Similar */;
            }
        }
        else if (nameResult === "equal" /* ContactComparisonResult.Equal */ || nameResult === "similar" /* ContactComparisonResult.Similar */) {
            return "similar" /* ContactComparisonResult.Similar */;
        }
        else if ((nameResult === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */ || nameResult === "oneEmpty" /* IndifferentContactComparisonResult.OneEmpty */) &&
            (mailResult === "similar" /* ContactComparisonResult.Similar */ ||
                phoneResult === "similar" /* ContactComparisonResult.Similar */ ||
                mailResult === "equal" /* ContactComparisonResult.Equal */ ||
                phoneResult === "equal" /* ContactComparisonResult.Equal */)) {
            return "similar" /* ContactComparisonResult.Similar */;
        }
        else {
            return "unique" /* ContactComparisonResult.Unique */;
        }
    }
    else {
        return "unique" /* ContactComparisonResult.Unique */;
 ...
 * Export for testing
 */
export function _compareFullName(contact1, contact2) {
    if (contact1.firstName === contact2.firstName && contact1.lastName === contact2.lastName && (contact1.lastName || contact1.firstName)) {
        ...
        return "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */;
    }
    else if ((!contact1.firstName && !contact1.lastName) || (!contact2.firstName && !contact2.lastName)) {
        return "oneEmpty" /* IndifferentContactComparisonResult.OneEmpty */;
    }
 ...
 * Export for testing
 */
export function _getMergedNameField(name1, name2) {
    if (name1) {
        return name1;
    }
    else {
 ...
 * Export for testing
 */
export function _compareMailAddresses(contact1MailAddresses, contact2MailAddresses) {
    return _compareValues(contact1MailAddresses.map((m) => m.address), contact2MailAddresses.map((m) => m.address));
}
/**
 * Export for testing
 */
export function _getMergedEmailAddresses(mailAddresses1, mailAddresses2) {
 ...
 * Export for testing
 */
export function _comparePhoneNumbers(contact1PhoneNumbers, contact2PhoneNumbers) {
    return _compareValues(contact1PhoneNumbers.map((m) => m.number), contact2PhoneNumbers.map((m) => m.number));
}
/**
 * Export for testing
 */
export function _getMergedPhoneNumbers(phoneNumbers1, phoneNumbers2) {
 ...
 */
export function _areResidualContactFieldsEqual(contact1, contact2) {
...
function _areSocialIdsEqual(contact1SocialIds, contact2SocialIds) {
    ...
    return result === "bothEmpty" /* IndifferentContactComparisonResult.BothEmpty */ || result === "equal" /* ContactComparisonResult.Equal */;
}
/**
 * Export for testing
 */
export function _getMergedSocialIds(socialIds1, socialIds2) {
 ...
 * Export for testing
 */
export function _getMergedAddresses(addresses1, addresses2) {
 ...
 * Export for testing
 */
export function _compareBirthdays(contact1, contact2) {
 ...
 * Export for testing
 */
export function _getMergedOtherField(otherAttribute1, otherAttribute2, separator) {
 ...
 * Export for testing
 */
export function _getMergedBirthdays(birthday1, birthday2) {
...
//# sourceMappingURL=ContactMergeUtils.js.map