...
import { debounce, downcast, isSameTypeRef, memoized, mod, ofClass } from "@tutao/tutanota-utils";
...
export class SearchBar {
    ...
    state;
    busy = false;
    lastSelectedWhitelabelChildrenInfoResult = stream();
        ...
        if (isSameTypeRef(restriction.type, ContactTypeRef)) {
            ...
            return {
                filteredEntries: instances
                    ...
                    .sort((o1, o2) => compareContacts(o1, o2))
