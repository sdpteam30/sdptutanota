 ...
 */
export class KnowledgeBaseEntryView {
    _sanitizedEntry;
    constructor() {
    ...
    _renderContent(attrs) {
        ...
        return m("", {
            ...
            m(".flex.mt-l.center-vertically.selectable", m(".h4.text-ellipsis", entry.title), !readonly ? [m(".flex.flex-grow.justify-end", [this.renderEditButton(entry), this.renderRemoveButton(entry)])] : null),
            m("", [
...
//# sourceMappingURL=KnowledgeBaseEntryView.js.map