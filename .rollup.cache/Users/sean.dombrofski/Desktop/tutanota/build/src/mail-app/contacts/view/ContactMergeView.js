...
import { getContactSocialType, Keys } from "../../../common/api/common/TutanotaConstants";
...
export class ContactMergeView {
    ...
    contact1;
    contact2;
    resolveFunction = null; // must be called after the user action
    windowCloseUnsubscribe = null;
    constructor(contact1, contact2) {
        this.contact1 = contact1;
        this.contact2 = contact2;
        const cancelAction = () => {
            this._close("cancel" /* ContactMergeAction.Cancel */);
        };
        const headerBarAttrs = {
            ...
            right: [
                {
                    label: "skip_action",
                    click: () => this._close("skip" /* ContactMergeAction.Skip */),
    ...
    view() {
        ...
        let emptyHTMLFieldPlaceholder = m(new HtmlEditor("emptyString_msg").showBorders().setValue("").setReadOnly(false).setMode(HtmlEditorMode.HTML).setHtmlMonospace(false));
            ...
            m(".flex-center.mt", [
                m(".full-width.max-width-s", [
                    m(LoginButton, {
                        ...
                        onclick: () => this._close("merge" /* ContactMergeAction.Merge */),
                    }),
                ]),
            ]),
            m(".non-wrapping-row", [
                ...
                [
                    m(".items-center", [
                        m(".items-base.flex-space-between", [
                            ...
                            this._createDeleteContactButton("deleteFirst" /* ContactMergeAction.DeleteFirst */),
                        ]),
                    ]),
                ]),
                m("", 
                ...
                [
                    m(".items-center", [
                        m(".items-base.flex-space-between", [
                            ...
                            this._createDeleteContactButton("deleteSecond" /* ContactMergeAction.DeleteSecond */),
                        ]),
                    ]),
                ]),
            ]),
...
//# sourceMappingURL=ContactMergeView.js.map