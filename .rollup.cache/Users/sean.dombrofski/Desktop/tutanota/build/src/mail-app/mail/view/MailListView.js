...
import { Keys, MailSetKind } from "../../../common/api/common/TutanotaConstants";
...
export class MailListView {
    ...
    _newDragStart(event, row, selected) {
        ...
        if (isExportDragEvent(event)) {
            ...
            neverNull(event.dataTransfer).setData("Mail" /* DropType.Mail */, getLetId(neverNull(mailUnderCursor))[1]);
        }
        else {
            event.preventDefault();
        }
    ...
    async onSwipeLeft(listElement) {
        ...
        return wereDeleted ? 1 /* ListSwipeDecision.Commit */ : 0 /* ListSwipeDecision.Cancel */;
    }
    async onSwipeRight(listElement) {
        if (this.showingDraft) {
            ...
            return 0 /* ListSwipeDecision.Cancel */;
        }
        else {
            ...
            if (folders) {
                ...
                return wereMoved ? 1 /* ListSwipeDecision.Commit */ : 0 /* ListSwipeDecision.Cancel */;
            }
            else {
                return 0 /* ListSwipeDecision.Cancel */;
            }
    ...
    renderLeftSpacer() {
        return this.showingDraft
            ...
            : [
                ...
                m(".pl-s", this.showingSpamOrTrash
...
export function isExportDragEvent(event) {
...
//# sourceMappingURL=MailListView.js.map