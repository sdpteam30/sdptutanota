...
import { MailSetKind, MAX_NBR_MOVE_DELETE_MAIL_SERVICE } from "../../../common/api/common/TutanotaConstants";
...
export function getInboxRuleTypeNameMapping() {
    return [
        {
...
export function getInboxRuleTypeName(type) {
 ...
 */
export async function _findMatchingRule(mailFacade, mail, rules) {
...
/** export for test. */
export function _matchesRegularExpression(value, inboxRule) {
...
export async function isInboxFolder(mailboxDetail, mail) {
...
//# sourceMappingURL=InboxRuleHandler.js.map