        ...
        return {
            ...
            async onFullLoginSuccess() {
                ...
                if (isOfflineStorageAvailable()) {
                    await mailLocator.logins.loadCustomizations(1 /* CacheMode.WriteOnly */);
                    m.redraw();
                }
                if (mailLocator.mailModel.canManageLabels() && !mailLocator.logins.getUserController().props.defaultLabelCreated) {
                    ...
                    const reloadTutanotaProperties = await mailLocator.entityClient.loadRoot(TutanotaPropertiesTypeRef, mailLocator.logins.getUserController().user.userGroup.group, { cacheMode: 1 /* CacheMode.WriteOnly */ });
        ...
        mailLocator.logins.addPostLoginAction(async () => {
            return {
                ...
                onFullLoginSuccess: async (event) => {
                    ...
                    if (event.sessionType === 2 /* SessionType.Persistent */) {
