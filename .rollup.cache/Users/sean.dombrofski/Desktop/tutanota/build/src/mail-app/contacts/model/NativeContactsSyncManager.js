...
import { ContactTypeRef, createContact, createContactAddress, createContactCustomDate, createContactMailAddress, createContactMessengerHandle, createContactPhoneNumber, createContactRelationship, createContactWebsite, } from "../../../common/api/entities/tutanota/TypeRefs.js";
...
import { extractStructuredAddresses, extractStructuredCustomDates, extractStructuredMailAddresses, extractStructuredMessengerHandle, extractStructuredPhoneNumbers, extractStructuredRelationships, extractStructuredWebsites, } from "../../../common/contactsFunctionality/ContactUtils.js";
...
export class NativeContactsSyncManager {
    ...
    constructor(loginController, mobileContactsFacade, entityClient, eventController, contactModel, deviceConfig) {
    ...
    async canSync() {
        ...
        const isContactPermissionGranted = await locator.systemPermissionHandler.requestPermission("0" /* PermissionType.Contacts */, "allowContactReadWrite_msg");
...
//# sourceMappingURL=NativeContactsSyncManager.js.map