 ...
 * Export for testing
 */
export function _contactToVCard(contact) {
 ...
 */
export function _addressesToVCardAddresses(addresses) {
    return addresses.map((ad) => {
        let kind = "";
        switch (ad.type) {
            case "0" /* ContactAddressType.PRIVATE */:
                kind = "home";
                break;
            case "1" /* ContactAddressType.WORK */:
                kind = "work";
                break;
            default:
        }
 ...
 */
export function _phoneNumbersToVCardPhoneNumbers(numbers) {
    return numbers.map((num) => {
        let kind = "";
        switch (num.type) {
            case "0" /* ContactPhoneNumberType.PRIVATE */:
                kind = "home";
                break;
            case "1" /* ContactPhoneNumberType.WORK */:
                kind = "work";
                break;
            case "2" /* ContactPhoneNumberType.MOBILE */:
                kind = "cell";
                break;
            case "3" /* ContactPhoneNumberType.FAX */:
                kind = "fax";
                break;
            default:
        }
 ...
 */
export function _socialIdsToVCardSocialUrls(socialIds) {
 ...
 */
export function _vCardFormatArrayToString(typeAndContentArray, tagContent) {
...
//# sourceMappingURL=VCardExporter.js.map