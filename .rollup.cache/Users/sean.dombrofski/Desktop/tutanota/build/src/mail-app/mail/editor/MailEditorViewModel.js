...
import { isDataFile, isFileReference, isTutanotaFile } from "../../../common/api/common/utils/FileUtils";
import { showFileChooser } from "../../../common/file/FileController.js";
import { ProgrammingError } from "../../../common/api/common/error/ProgrammingError.js";
import { AttachmentType } from "../../../common/gui/AttachmentBubble.js";
export async function chooseAndAttachFile(model, boundingRect, fileTypes) {
...
export function showFileChooserForAttachments(boundingRect, fileTypes) {
...
export function createAttachmentBubbleAttrs(model, inlineImageElements) {
...
export const cleanupInlineAttachments = debounce(50, (domElement, inlineImageElements, attachments) => {
...
export function getConfidentialStateMessage(isConfidential) {
    return isConfidential ? lang.get("confidentialStatus_msg") : lang.get("nonConfidentialStatus_msg");
}
//# sourceMappingURL=MailEditorViewModel.js.map