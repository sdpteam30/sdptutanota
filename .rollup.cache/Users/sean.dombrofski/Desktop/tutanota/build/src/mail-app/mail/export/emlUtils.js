import { createDataFile, getCleanedMimeType } from "../../../common/api/common/DataFile.js";
 ...
 */
export function mailToEml(mail) {
    const lines = [];
    if (mail.headers) {
        ...
        const formatRecipients = (key, recipients) => `${key}: ${recipients
...
export function generateExportFileName(id, subject, sentOn, mode) {
...
//# sourceMappingURL=emlUtils.js.map