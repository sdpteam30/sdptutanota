 ...
 */
export function iterateBinaryBlocks(row, cb) {
    let offset = 0;
    let iterations = 0;
 ...
 */
export function removeBinaryBlockRanges(row, ranges) {
    let reducedLength = 0;
 ...
 */
export function appendBinaryBlocks(source, destination) {
 ...
 */
export function encodeBinaryBlock(entityData, target, offset) {
 ...
 */
export function encodeNumberBlock(value, target, offset) {
 ...
 */
export function decodeBinaryBlock(source, offset) {
 ...
 */
export function decodeNumberBlock(source, offset) {
 ...
 */
export function calculateNeededSpace(data) {
 ...
 */
export function calculateNeededSpaceForNumber(value) {
 ...
 */
export function decodeNumbers(binaryNumbers, offset = 0) {
    const numbers = [];
 ...
 */
export function encodeNumbers(numbers, target, offset = 0) {
    for (const number of numbers) {
        offset += encodeNumberBlock(number, target, offset);
    }
}
//# sourceMappingURL=SearchIndexEncoding.js.map