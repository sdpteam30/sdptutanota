...
export class ColorPickerView {
    ...
    fallbackVariantIndex = 2 /* PaletteIndex.defaultVariant */;
    isAdvanced = false;
    customColorHex = "";
    huePickerDom = null;
    hueImgDom = null;
    ...
    constructor(vnode) {
        ...
        if (selectedColor) {
            ...
            this.generatePalette();
            const defaultColor = assertNotNull(this.palette[2 /* PaletteIndex.defaultVariant */], "no default palette color variant");
    ...
    view(vnode) {
        ...
        return m(".color-picker", [
            ...
            m(".flex.wrap.full-width.items-center.justify-between.p0.plr-s", {
                style: {
    ...
    renderCustomColorContainer(attrs) {
        return m(".custom-color-container.flex.items-start.gap-hpad", [
            ...
            this.renderColorOption({
                ...
                index: -1 /* PaletteIndex.customVariant */,
                selectedColor: attrs.value,
                onselect: (color) => {
    ...
    renderColorOption(attrs) {
        ...
        if (index === -1 /* PaletteIndex.customVariant */) {
        ...
        const handleSelection = () => {
            ...
            if (index === -1 /* PaletteIndex.customVariant */ && isColorValid) {
        ...
        return m(`.color-option${className ?? ""}`, {
            ...
            role: "radio",
            ariaLabel: index === -1 /* PaletteIndex.customVariant */ ? lang.get("customColor_label") : `${lang.get("variant_label")} ${index}`,
    ...
    renderHuePicker(onselect) {
        ...
        return m(".rel.overflow-hidden", {
            ...
            // hueGradient
            m(".full-width.border-radius.overflow-hidden", {
                style: {
                    borderStyle: "solid",
