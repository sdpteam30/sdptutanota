 ...
 */
export function getCardTypeRange(cc) {
 ...
 */
export function isDigitString(s) {
    if (s.length === 0)
        return false;
 ...
 */
function groupCreditCardNumber(value, groups = [4, 4, 4, 4, 4]) {
 ...
 */
export function getExpirationMonthAndYear(expirationDate) {
...
export class SimplifiedCreditCardViewModel {
    lang;
    _cardHolderName = "";
    _creditCardNumber = "";
    _cvv = "";
...
//# sourceMappingURL=SimplifiedCreditCardInputModel.js.map