...
export async function suspensionAwareFetch(input, init) {
    ...
    if ((res.status === ServiceUnavailableError.CODE || TooManyRequestsError.CODE) && (res.headers.get("retry-after") || res.headers.get("suspension-time"))) {
        ...
        const time = filterInt((res.headers.get("retry-after") ?? res.headers.get("suspension-time")));
...
//# sourceMappingURL=SuspensionAwareFetch.js.map