 ...
 */
export function birthdayToIsoDate(birthday) {
 ...
 */
export function isoDateToBirthday(birthdayIso) {
 ...
 * Export for testing
 */
export function oldBirthdayToBirthday(oldBirthday) {
...
//# sourceMappingURL=BirthdayUtils.js.map