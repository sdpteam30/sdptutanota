import { addParamsToUrl, isSuspensionResponse } from "../../rest/RestClient.js";
import { assertNonNull, base64ToBase64Ext, clear, concat, getFirstOrThrow, groupBy, isEmpty, mapMap, neverNull, promiseMap, splitUint8ArrayInChunks, uint8ArrayToBase64, uint8ArrayToString, } from "@tutao/tutanota-utils";
import { MAX_BLOB_SIZE_BYTES } from "../../../common/TutanotaConstants.js";
...
import { createBlobReferenceTokenWrapper } from "../../../entities/sys/TypeRefs.js";
import { handleRestError } from "../../../common/error/RestError.js";
import { ProgrammingError } from "../../../common/error/ProgrammingError.js";
import { BlobGetInTypeRef, BlobPostOutTypeRef, createBlobGetIn, createBlobId } from "../../../entities/storage/TypeRefs.js";
...
export class BlobFacade {
    ...
    async encryptAndUploadChunk(chunk, blobServerAccessInfo, sessionKey) {
        ...
        return tryServers(blobServerAccessInfo.servers, async (serverUrl) => {
            const response = await this.restClient.request(BLOB_SERVICE_REST_PATH, "POST" /* HttpMethod.POST */, {
    ...
    async uploadNative(location, blobServerAccessInfo, serverUrl, blobHash) {
        ...
        const { suspensionTime, responseBody, statusCode, errorId, precondition } = await this.fileApp.upload(location, fullUrl.toString(), "POST" /* HttpMethod.POST */, {}); // blobReferenceToken in the response body
        if (statusCode === 201 && responseBody != null) {
            ...
            throw handleRestError(statusCode, ` | ${"POST" /* HttpMethod.POST */} ${fullUrl.toString()} failed to natively upload blob`, errorId, precondition);
        }
    }
    ...
    async downloadBlobsOfOneArchive(blobs, blobServerAccessInfo, blobLoadOptions) {
        ...
        const concatBinaryData = await tryServers(blobServerAccessInfo.servers, async (serverUrl) => {
            return await this.restClient.request(BLOB_SERVICE_REST_PATH, "GET" /* HttpMethod.GET */, {
                queryParams: queryParams,
                body,
    ...
    async downloadNative(serverUrl, blobServerAccessInfo, sessionKey, fileName, additionalParams) {
        ...
        if (statusCode == 200 && encryptedFileUri != null) {
            ...
            throw handleRestError(statusCode, ` | ${"GET" /* HttpMethod.GET */} failed to natively download attachment`, errorId, precondition);
        }
    }
}
/**
 ...
 */
export function parseMultipleBlobsResponse(concatBinaryData) {
...
//# sourceMappingURL=BlobFacade.js.map