...
import { addDaysForRecurringEvent, calculateContactsAge, createRepeatRuleWithValues, extractYearFromBirthday, generateUid, getEventEnd, getEventStart, getMonthRange, isBirthdayEvent, isClientOnlyCalendar, } from "./CalendarUtils.js";
import { CalendarEventTypeRef, ContactTypeRef, createCalendarEvent } from "../../api/entities/tutanota/TypeRefs.js";
import { getListId, isSameId, listIdPart } from "../../api/common/utils/EntityUtils.js";
import { DateTime } from "luxon";
import { findAllAndRemove, incrementDate, stringToBase64 } from "@tutao/tutanota-utils";
import { CLIENT_ONLY_CALENDAR_BIRTHDAYS_BASE_ID, RepeatPeriod } from "../../api/common/TutanotaConstants.js";
...
export class CalendarEventsRepository {
    ...
    async loadContactsBirthdays(forceReload = false) {
        ...
        const filteredContacts = contacts
            ...
            return (new Date(`${birthdayContactA.month}/${birthdayContactA.day}`).getTime() -
