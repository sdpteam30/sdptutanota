 ...
 */
export class ReferralLinkViewer {
    view(vnode) {
        return m(".scroll", [
    ...
    getReferralLinkTextFieldAttrs(referralLink) {
        return {
            ...
            helpLabel: () => ifAllowedTutaLinks(locator.logins, "https://tuta.com/faq#refer-a-friend" /* InfoLink.ReferralLink */, (link) => [m(MoreInfoLink, { link: link })]),
        };
    }
 ...
 */
export async function getReferralLink(userController) {
...
//# sourceMappingURL=ReferralLinkViewer.js.map