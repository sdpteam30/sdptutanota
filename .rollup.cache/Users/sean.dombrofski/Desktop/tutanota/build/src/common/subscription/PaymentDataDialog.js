 ...
 */
export async function show(customer, accountingInfo, price, defaultPaymentMethod) {
    ...
    const paymentMethodInput = new PaymentMethodInput(subscriptionOptions, stream(invoiceData.country), neverNull(accountingInfo), payPalRequestUrl, defaultPaymentMethod);
    ...
    return new Promise((resolve) => {
        const confirmAction = () => {
            ...
            if (error) {
                ...
                if (didLinkPaypal()) {
                    ...
                    showProgressDialog("updatePaymentDataBusy_msg", updatePaymentData(subscriptionOptions.paymentInterval(), invoiceData, paymentMethodInput.getPaymentData(), invoiceData.country, false, price + "", accountingInfo)).then(finish);
                }
            }
        };
        const dialog = Dialog.showActionDialog({
            ...
            child: {
                view: () => m("#changePaymentDataDialog", {
                    style: {
                        minHeight: px(310),
                    },
                }, [
...
//# sourceMappingURL=PaymentDataDialog.js.map