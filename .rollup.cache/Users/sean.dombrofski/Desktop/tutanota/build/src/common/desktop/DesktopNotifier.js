export class DesktopNotifier {
    ...
    _notificationCloseFunctions = {};
    _notificationFactory;
    constructor(tray, notificationFactory) {
        this._tray = tray;
    ...
    submitGroupedNotification(title, message, id, onClick) {
    ...
    resolveGroupedNotification(userId) {
