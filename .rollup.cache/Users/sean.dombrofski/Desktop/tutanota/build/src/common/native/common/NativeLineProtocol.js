 ...
 */
import { Request, RequestError, Response } from "../../api/common/threading/MessageDispatcher.js";
...
export function encodeValueForNative(value) {
    return JSON.stringify(replaceBytesWithWrapper(value));
}
const BYTES_MARKER = "__bytes";
export function replaceBytesWithWrapper(value) {
    if (value == null) {
        return null;
    }
...
export function replaceWrapperByBytes(value) {
    if (value == null) {
        return null;
    }
 ...
 * @param encoded
 */
export function decodeNativeMessage(encoded) {
...
export function decodeValueFromNative(encoded) {
    return replaceWrapperByBytes(JSON.parse(encoded));
}
//# sourceMappingURL=NativeLineProtocol.js.map