 ...
 */
export function parseMailtoUrl(mailtoUrl) {
 ...
 */
export function stringToNameAndMailAddress(string) {
    string = string.trim();
    if (string === "") {
        return null;
    }
 ...
 */
export function getCleanedMailAddress(mailAddress) {
...
export function getDomainPart(mailAddress) {
 ...
 */
export function fullNameToFirstAndLastName(fullName) {
 ...
 * @return Returns an object with the attributes "firstName" and "lastName".
 */
export function mailAddressToFirstAndLastName(mailAddress) {
...
//# sourceMappingURL=MailAddressParser.js.map