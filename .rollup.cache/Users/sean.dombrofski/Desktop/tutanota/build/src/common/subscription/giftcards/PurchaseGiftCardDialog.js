...
import { formatPrice, PriceAndConfigProvider } from "../PriceUtils";
        ...
        if (e instanceof PreconditionFailedError) {
            ...
            switch (message) {
                case "giftcard.limitreached":
                    throw new UserError(lang.getTranslation("tooManyGiftCards_msg", {
...
class GiftCardPurchaseView {
    view(vnode) {
        const { model, onGiftCardPurchased } = vnode.attrs;
        return [
            m(".flex.center-horizontally.wrap.pt-ml", {
                style: {
                ...
                return m(BuyOptionBox, {
                    heading: m(".flex-center", Array(Math.pow(2, index)).fill(m(Icon, {
                        icon: "Gift" /* Icons.Gift */,
                        size: IconSize.Medium,
                    }))),
                    actionButton: () => m(LoginButton, {
...
async function loadGiftCardModel() {
    ...
    return new PurchaseGiftCardModel({
        ...
        revolutionaryPrice: priceDataProvider.getSubscriptionPrice(12 /* PaymentInterval.Yearly */, PlanType.Revolutionary, "1" /* UpgradePriceType.PlanActualPrice */),
    });
}
//# sourceMappingURL=PurchaseGiftCardDialog.js.map