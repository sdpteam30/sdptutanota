 ...
 */
export function hasError(instance, key) {
...
export function isSecurityError(e) {
    return e instanceof DOMException && (e.name === "SecurityError" || e.code === e.SECURITY_ERR);
}
export function isNotSupportedError(e) {
