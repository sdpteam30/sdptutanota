...
export class MailExportTokenFacade {
    ...
    requestNewToken() {
        ...
        this.currentExportTokenRequest = this.serviceExecutor.post(MailExportTokenService, null, { suspensionBehavior: 1 /* SuspensionBehavior.Throw */ }).then((result) => {
...
//# sourceMappingURL=MailExportTokenFacade.js.map