...
export class ExpanderButton {
    view(vnode) {
        ...
        return m(".limit-width", m("button.expander.bg-transparent.pt-s.hover-ul.limit-width.flex.items-center.b.text-ellipsis.flash", {
            style: a.style,
            onclick: (event) => {
                a.onExpandedChange(!a.expanded);
                if (!a.isPropagatingEvents)
...
export class ExpanderPanel {
    ...
    view(vnode) {
        ...
        m(expanded ? "div" : ".overflow-hidden", {
            style: {
