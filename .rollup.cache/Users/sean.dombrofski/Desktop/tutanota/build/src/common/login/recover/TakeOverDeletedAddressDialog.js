...
assertMainOrNode();
export function showTakeOverDialog(mailAddress, password) {
    ...
    const takeoverDialog = Dialog.showActionDialog({
        ...
        child: {
            view: () => {
                return [
                    ...
                    m(MoreInfoLink, { link: "https://tuta.com/faq/#inactive-accounts" /* InfoLink.InactiveAccounts */ }),
                    m(TextField, {
                        label: "targetAddress_label",
                        value: targetAccountAddress(),
                        autocompleteAs: "email" /* Autocomplete.email */,
        ...
        okAction: () => {
            ...
            if (!isMailAddress(cleanMailAddress, true)) {
                ...
                showProgressDialog("pleaseWait_msg", locator.loginFacade.takeOverDeletedAddress(cleanMailAddress, password, cleanRecoveryCode, cleanTargetAccountAddress))
...
//# sourceMappingURL=TakeOverDeletedAddressDialog.js.map