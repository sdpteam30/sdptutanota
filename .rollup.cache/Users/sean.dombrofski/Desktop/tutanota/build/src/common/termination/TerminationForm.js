...
export class TerminationForm {
    ...
    view(vnode) {
        ...
        return m("form", {
            ...
            m("", {
                oncreate: (vnode) => {
                    const childArray = assertNotNull(vnode.children);
    ...
    handleAutofill(a) {
        ...
        requestAnimationFrame(() => {
            ...
            if (oldAddress !== newAddress)
                a.onMailAddressChanged(newAddress);
            if (oldPassword !== newPassword)
                a.onPasswordChanged(newPassword);
        });
    }
