 ...
 */
export function isMailAddress(string, strictUserName) {
 ...
 */
export function isDomainName(domainName) {
...
export function isDomainOrTopLevelDomain(value) {
    if (startsWith(value, "-")) {
        return false;
    }
 ...
 * @returns {boolean}
 */
export function isValidCreditCardNumber(input) {
