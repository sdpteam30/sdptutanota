...
export const DesktopListToolbar = pureComponent((__, children) => {
    return m(".flex.pt-xs.pb-xs.items-center.list-bg", {
        style: {
...
export const DesktopViewerToolbar = pureComponent((__, children) => {
    ...
    return m(".scrollbar-gutter-stable-or-fallback.overflow-y-hidden.noprint", {
        class: responsiveCardHMargin(),
        style: {
            marginLeft: 0,
            marginBottom: px(size.hpad_large),
        },
    }, m(".flex.list-bg.pt-xs.pb-xs.plr-m", {
        style: {
...
//# sourceMappingURL=DesktopToolbars.js.map