...
export function parseDate(dateString, referenceDateRenderer) {
 ...
 * @private
 */
export function _getNumDaysInMonth(month, year) {
 ...
 */
export function parseBirthday(text, referenceDateRenderer) {
    try {
        const referenceParts = _cleanupAndSplit(referenceDateRenderer(referenceDate));
        //for finding day month and year position of locale date format  in cleanAndSplit array
...
export function _cleanupAndSplit(dateString) {
