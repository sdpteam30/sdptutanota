...
export function showDeleteAccountDialog(surveyData = null) {
    let takeover = "";
    let password = "";
...
async function deleteAccount(takeover, password, surveyData = null) {
    ...
    if (cleanedTakeover === null) {
        ...
        const message = lang.makeTranslation("confirm_msg", cleanedTakeover === ""
        ...
        await locator.connectivityModel.close("terminate" /* CloseEventBusOption.Terminate */);
        try {
            ...
            if (e instanceof PreconditionFailedError)
                await Dialog.message("passwordWrongInvalid_msg");
            if (e instanceof InvalidDataError)
                await Dialog.message("takeoverAccountInvalid_msg");
