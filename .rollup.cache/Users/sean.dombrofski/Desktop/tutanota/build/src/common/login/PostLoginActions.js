...
import { Const, SecondFactorType } from "../api/common/TutanotaConstants";
import { showMoreStorageNeededOrderDialog } from "../misc/SubscriptionDialogs.js";
import { notifications } from "../gui/Notifications";
import { LockedError } from "../api/common/error/RestError";
import { usingKeychainAuthenticationWithOptions } from "../misc/credentials/CredentialsProvider.js";
...
export class PostLoginActions {
    ...
    async onFullLoginSuccess(loggedInEvent) {
        if (loggedInEvent.sessionType === 1 /* SessionType.Temporary */ || !this.logins.getUserController().isInternalUser()) {
            return;
        }
        // Do not wait
    ...
    async fullLoginAsyncActions() {
        ...
        usageTestModel.setStorageBehavior(0 /* StorageBehavior.Persist */);
...
//# sourceMappingURL=PostLoginActions.js.map