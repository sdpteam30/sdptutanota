import { MARGIN_LEFT, MARGIN_TOP, PDF_FONTS, PDF_IMAGES, PdfDocument, TABLE_VERTICAL_SPACING } from "../pdf/PdfDocument.js";
...
export class PdfInvoiceGenerator {
    ...
    renderTableSummary(tableEndPoint, columns) {
        ...
        // VAT
        if (this.invoice.vatType === "1" /* VatType.ADD_VAT */) {
            // AddedVat
        ...
        else if (this.invoice.vatType === "2" /* VatType.VAT_INCLUDED_SHOWN */) {
            // IncludedVat
            this.doc.addTableRow([MARGIN_LEFT, tableEndPoint + TABLE_VERTICAL_SPACING], columns, [
                "",
                "",
        ...
        this.doc.addTableRow([MARGIN_LEFT, tableEndPoint + (additionalVerticalSpace + 1) * TABLE_VERTICAL_SPACING], columns, [
            ...
            this.formatInvoiceCurrency(this.invoice.vatType == "4" /* VatType.NO_VAT_CHARGE_TUTAO */ ? this.invoice.subTotal : this.invoice.grandTotal),
        ]);
    }
    /**
    ...
    renderAdditional() {
        ...
        switch (this.invoice.vatType) {
            case "1" /* VatType.ADD_VAT */:
            case "2" /* VatType.VAT_INCLUDED_SHOWN */:
                break;
            case "0" /* VatType.NO_VAT */:
                ...
                break;
            case "4" /* VatType.NO_VAT_CHARGE_TUTAO */:
                this.doc
    ...
    getTableRowsForFirstPage() {
        if (this.invoice.paymentMethod === "0" /* PaymentMethod.INVOICE */ &&
            this.invoice.vatIdNumber != null &&
            // Needs fix @arm, @jug, @jop
            (this.invoice.vatType === "0" /* VatType.NO_VAT */ || this.invoice.vatType === "4" /* VatType.NO_VAT_CHARGE_TUTAO */)) {
    ...
    formatAmount(itemType, amount) {
        if (itemType === "4" /* InvoiceItemType.StoragePackage */ || itemType === "5" /* InvoiceItemType.StoragePackageUpgrade */) {
...
//# sourceMappingURL=PdfInvoiceGenerator.js.map