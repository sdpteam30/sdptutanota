...
export function showAddAliasDialog(model, isNewPaidPlan) {
                ...
                view: () => {
                    return [
                        m(SelectMailAddressForm, {
                            ...
                            onDomainChanged: (domain) => {
                                if (!domain.isPaid || isNewPaidPlan) {
                                    ...
                                    Dialog.confirm(lang.makeTranslation("confirm_msg", `${lang.get("paidEmailDomainLegacy_msg")}\n${lang.get("changePaidPlan_msg")}`)).then(async (confirmed) => {
                                        if (confirmed) {
                        ...
                        m(TextField, {
                            ...
                            value: senderName,
                            autocompleteAs: "username" /* Autocomplete.username */,
...
//# sourceMappingURL=AddAliasDialog.js.map