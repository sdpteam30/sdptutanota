...
export function createMoreActionButtonAttrs(lazyChildren, dropdownWidth) {
    return {
        title: "more_label",
 ...
 */
export function getConfirmation(message, confirmMessage = "ok_action") {
 ...
 */
export function getCoordsOfMouseOrTouchEvent(event) {
...
export function makeListSelectionChangedScrollHandler(scrollDom, entryHeight, getSelectedEntryIndex) {
    return function () {
        scrollListDom(scrollDom, entryHeight, getSelectedEntryIndex());
    };
}
export function scrollListDom(scrollDom, entryHeight, selectedIndex) {
 ...
 */
export function ifAllowedTutaLinks(logins, linkId, render) {
 ...
 */
export function canSeeTutaLinks(logins) {
 ...
 * @param mouseEvent
 */
export function getPosAndBoundsFromMouseEvent({ currentTarget, x, y }) {
...
export function renderTwoColumnsIfFits(left, right) {
...
export function getOperatingClasses(isDisabled, cursorClass) {
...
export function getIfLargeScroll(oldPosition, newPosition) {
...
export function colorForBg(color) {
