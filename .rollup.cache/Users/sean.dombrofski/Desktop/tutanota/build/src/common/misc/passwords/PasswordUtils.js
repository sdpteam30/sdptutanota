 ...
 */
export function getPasswordStrength(password, badStrings) {
...
export function getPasswordStrengthForUser(password, recipientInfo, mailboxDetails, logins) {
 ...
 */
export function scaleToVisualPasswordStrength(passwordStrength) {
    return Math.min(100, (passwordStrength / PASSWORD_MAX_VALUE) * 100);
}
export function isSecurePassword(passwordStrength) {
 ...
 */
export function _getNbrOfSequenceChars(password, sequences, reverseToo) {
