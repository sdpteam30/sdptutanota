...
export class EmailSupportUnavailablePage {
    view({ attrs: { data, goToContactSupportPage } }) {
        return m(".pt.pb", m(Card, { shouldDivide: true }, m("div.pt-s.pb-s.plr", [
...
//# sourceMappingURL=EmailSupportUnavailablePage.js.map