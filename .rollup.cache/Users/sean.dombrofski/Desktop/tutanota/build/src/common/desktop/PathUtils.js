 ...
 */
export function nonClobberingFilename(files, filename) {
...
export function looksExecutable(file) {
...
export function parseUrlOrNull(urlString) {
    try {
...
export function urlIsPrefix(prefix, url) {
 ...
 */
export function swapFilename(p, file, pathModule = path) {
