...
export function renderInfoLinks() {
    const privacyPolicyLink = getPrivacyStatementLink();
    const imprintLink = getImprintLink();
    return m(".flex.col.mt-l", m(".flex.wrap.justify-center", !isApp() && privacyPolicyLink
        ? m(ExternalLink, {
        ...
        : null), m(".mt.mb.center.small.full-width", {
        onclick: (e) => showVersionDropdown(e),
    }, `v${env.versionNumber}`));
}
function getImprintLink() {
    return mapNullable(getWhitelabelCustomizations(window), (c) => c.imprintUrl) || "https://tuta.com/imprint" /* InfoLink.About */;
}
function getPrivacyStatementLink() {
    return mapNullable(getWhitelabelCustomizations(window), (c) => c.privacyStatementUrl) || "https://tuta.com/privacy-policy" /* InfoLink.Privacy */;
}
/**
...
//# sourceMappingURL=RenderLoginInfoLinks.js.map