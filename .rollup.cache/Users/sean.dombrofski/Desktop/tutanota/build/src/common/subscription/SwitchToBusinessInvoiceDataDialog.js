 ...
 */
export function showSwitchToBusinessInvoiceDataDialog(customer, invoiceData, accountingInfo) {
    ...
    const confirmAction = async () => {
        ...
        if (error) {
            ...
            const success = await updatePaymentData(asPaymentInterval(accountingInfo.paymentInterval), invoiceDataInput.getInvoiceData(), null, null, false, "0", accountingInfo)
                .catch(ofClass(BadRequestError, () => {
...
//# sourceMappingURL=SwitchToBusinessInvoiceDataDialog.js.map