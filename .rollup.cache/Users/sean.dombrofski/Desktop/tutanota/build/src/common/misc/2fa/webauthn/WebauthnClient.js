...
import { downcast, getFirstOrThrow, partitionAsync, stringToUtf8Uint8Array } from "@tutao/tutanota-utils";
import { createU2fRegisteredDevice, createWebauthnResponseData } from "../../../api/entities/sys/TypeRefs.js";
...
export class WebauthnClient {
    ...
    isApp;
    constructor(webauthn, domainConfigProvider, isApp) {
 ...
 */
export function validateWebauthnDisplayName(displayName) {
