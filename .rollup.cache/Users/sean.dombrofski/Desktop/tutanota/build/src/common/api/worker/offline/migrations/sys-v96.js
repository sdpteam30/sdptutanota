import { AccountingInfoTypeRef, AuditLogEntryTypeRef, CustomerServerPropertiesTypeRef, GiftCardTypeRef, GroupInfoTypeRef, GroupTypeRef, InvoiceTypeRef, MissedNotificationTypeRef, OrderProcessingAgreementTypeRef, PushIdentifierTypeRef, ReceivedGroupInvitationTypeRef, RecoverCodeTypeRef, UserAlarmInfoTypeRef, UserGroupRootTypeRef, UserTypeRef, WhitelabelChildTypeRef, } from "../../../entities/sys/TypeRefs.js";
import { addOwnerKeyVersion, addValue, changeCardinalityFromAnyToZeroOrOne, migrateAllElements, migrateAllListElements, removeValue, renameAttribute, } from "../StandardMigrations.js";
export const sys96 = {
    app: "sys",
    version: 96,
...
//# sourceMappingURL=sys-v96.js.map