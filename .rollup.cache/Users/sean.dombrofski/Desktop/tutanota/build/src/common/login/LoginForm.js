...
export class LoginForm {
    ...
    view(vnode) {
        ...
        return m("form", {
                ...
                ? isApp() || isDesktop()
                    ...
                    : m("", {
                        ...
                        helpLabel: canSaveCredentials
                            ? lang.makeTranslation("onlyPrivateComputer_msg", lang.get("onlyPrivateComputer_msg") +
            ...
            m("p.center.statusTextColor.mt-s", {
                style: {
                    // browser reset
                    marginBottom: 0,
                },
                ...
                a.invalidCredentials && a.showRecoveryOption
                    ...
                    : a.accessExpired && a.accessExpired
                        ? m("a", {
                            ...
                            href: "#",
                            onclick: (e) => {
                                import("./recover/TakeOverDeletedAddressDialog.js").then(({ showTakeOverDialog }) => showTakeOverDialog(a.mailAddress(), a.password()));
                                e.preventDefault();
                            },
                        }, lang.get("help_label"))
                        : null,
