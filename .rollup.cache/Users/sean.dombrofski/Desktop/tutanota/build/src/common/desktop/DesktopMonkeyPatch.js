...
console.info = (...args) => oldInfo(`[${new Date().toISOString()}]`, ...args);
console.log = (...args) => oldLog(`[${new Date().toISOString()}]`, ...args);
console.error = (...args) => oldError(`[${new Date().toISOString()}]`, ...args);
console.warn = (...args) => oldWarn(`[${new Date().toISOString()}]`, ...args);
console.trace = (...args) => oldTrace(`[${new Date().toISOString()}]`, ...args);
...
//# sourceMappingURL=DesktopMonkeyPatch.js.map