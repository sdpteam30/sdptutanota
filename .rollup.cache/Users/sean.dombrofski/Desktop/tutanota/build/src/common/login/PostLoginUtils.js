...
export async function shouldShowUpgradeReminder(userController, date) {
    ...
    if (!userController.isGlobalAdmin() || (await userController.isNewPaidPlan()) || isIOSApp())
        return false;
    ...
    if (userController.isFreeAccount()) {
        ...
        const wasRemindedLongAgo = customerProperties.lastUpgradeReminder != null &&
...
export async function shouldShowStorageWarning(userController, userManagementFacade, customerFacade) {
    const customerInfo = await userController.loadCustomerInfo();
...
//# sourceMappingURL=PostLoginUtils.js.map