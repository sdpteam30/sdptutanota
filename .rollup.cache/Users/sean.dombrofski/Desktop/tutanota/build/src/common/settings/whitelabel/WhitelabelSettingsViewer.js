...
import { BookingTypeRef, createStringWrapper, CustomerInfoTypeRef, CustomerPropertiesTypeRef, CustomerTypeRef, WhitelabelConfigTypeRef, } from "../../api/entities/sys/TypeRefs.js";
...
export class WhitelabelSettingsViewer {
    ...
    view() {
        ...
        return m("#global-settings.fill-absolute.scroll.plr-l", brandingDomainConfig
            ? [
                ...
                m("small.text-break", [m(`a[href=${"https://tuta.com/faq#whitelabel" /* InfoLink.Whitelabel */}][target=_blank]`, "https://tuta.com/faq#whitelabel" /* InfoLink.Whitelabel */)]),
    ...
    _renderWhitelabelRegistrationSettings() {
        if (!this._isWhitelabelRegistrationVisible())
            return null;
    ...
    _renderDefaultGermanLanguageFileSettings() {
        if (!this._whitelabelConfig)
            return null;
        if (lang.code !== "de" && lang.code !== "de_sie")
            return null;
    ...
    entityEventsReceived(updates) {
        return promiseMap(updates, (update) => {
            if (isUpdateForTypeRef(CustomerTypeRef, update) && update.operation === "1" /* OperationType.UPDATE */) {
            ...
            else if (isUpdateForTypeRef(WhitelabelConfigTypeRef, update) && update.operation === "1" /* OperationType.UPDATE */) {
                return this._updateFields();
            }
            else if (isUpdateForTypeRef(CustomerPropertiesTypeRef, update) && update.operation === "1" /* OperationType.UPDATE */) {
...
//# sourceMappingURL=WhitelabelSettingsViewer.js.map