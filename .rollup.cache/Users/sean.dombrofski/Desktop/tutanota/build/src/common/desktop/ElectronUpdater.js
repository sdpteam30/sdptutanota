...
export class ElectronUpdater {
    ...
    constructor(conf, notifier, crypto, app, icon, updater, fs, scheduler = setInterval) {
        ...
        this.logger = {
            info: (m, ...args) => console.log.apply(console, [TAG, "INFO:", m].concat(args)),
            warn: (m, ...args) => console.warn.apply(console, [TAG, "WARN:", m].concat(args)),
            error: (m, ...args) => console.error.apply(console, [TAG, "ERROR:", m].concat(args)),
            verbose: (m, ...args) => console.log.apply(console, [TAG, ":", m].concat(args)),
            debug: (m, ...args) => console.log.apply(console, [TAG, "DEBUG:", m].concat(args)),
            silly: (m, ...args) => console.log.apply(console, [TAG, "DEBUG:", m].concat(args)),
        };
    ...
    verifySignature(pubKey, updateInfo, data) {
...
//# sourceMappingURL=ElectronUpdater.js.map