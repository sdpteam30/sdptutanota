...
import { assertNotNull, base64ToBase64Url, base64ToUint8Array, downcast, promiseMap, stringToUtf8Uint8Array, TypeRef, uint8ArrayToBase64, utf8Uint8ArrayToString, } from "@tutao/tutanota-utils";
...
export class InstanceMapper {
    ...
    encryptAndMapToLiteral(model, instance, sk) {
        ...
        for (let key of Object.keys(model.values)) {
            ...
            else if (valueType.encrypted && i["_finalIvs"]?.[key]?.length === 0 && isDefaultValue(valueType.type, value)) {
...
export function encryptValue(valueName, valueType, value, sk, iv = random.generateRandomData(IV_BYTE_LENGTH)) {
...
// Exported for testing
export function decryptValue(valueName, valueType, value, sk) {
    if (value == null) {
        if (valueType.cardinality === Cardinality.ZeroOrOne) {
            return null;
        }
...
//# sourceMappingURL=InstanceMapper.js.map