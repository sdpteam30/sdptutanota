import { createDomainMailAddressAvailabilityData, createMailAddressAliasGetIn, createMailAddressAliasServiceData, createMailAddressAliasServiceDataDelete, createMultipleMailAddressAvailabilityData, createStringWrapper, GroupInfoTypeRef, GroupTypeRef, UserTypeRef, } from "../../../entities/sys/TypeRefs.js";
...
import { createMailAddressProperties, createMailboxProperties, MailboxGroupRootTypeRef, MailboxPropertiesTypeRef, } from "../../../entities/tutanota/TypeRefs.js";
...
export class MailAddressFacade {
    ...
    async getOrCreateMailboxProperties(mailGroupId, viaUser) {
        ...
        const groupKeyProvider = async (version) => viaUser
...
//# sourceMappingURL=MailAddressFacade.js.map