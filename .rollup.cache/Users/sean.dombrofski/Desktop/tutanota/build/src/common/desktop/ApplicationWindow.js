...
export class ApplicationWindow {
    ...
    absoluteAssetsPath, icon, electron, localShortcut, themeFacade, remoteBridge, noAutoLogin, preloadOverridePath) {
    ...
    createBrowserWindow(wm, opts) {
        ...
        this._browserWindow
            ...
            .on("blur", (_) => this.localShortcut.disableAll(this._browserWindow));
        this._browserWindow.webContents
            ...
            .on("zoom-changed", (ev, direction) => this._browserWindow.emit("zoom-changed", ev, direction))
    ...
    sendShortcutstoRender() {
        ...
        const webShortcuts = this.shortcuts.map((s) => Object.assign({}, s, {
            exec: null,
        }));
...
//# sourceMappingURL=ApplicationWindow.js.map