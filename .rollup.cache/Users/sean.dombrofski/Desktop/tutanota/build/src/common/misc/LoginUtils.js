...
import { AccessBlockedError, AccessDeactivatedError, AccessExpiredError, BadRequestError, ConnectionError, NotAuthenticatedError, NotAuthorizedError, NotFoundError, TooManyRequestsError, } from "../api/common/error/RestError";
import { CancelledError } from "../api/common/error/CancelledError";
import { ApprovalStatus, AvailablePlans, getCustomerApprovalStatus, NewBusinessPlans, NewPaidPlans, NewPersonalPlans, SubscriptionType, } from "../api/common/TutanotaConstants";
 ...
 */
export function checkApprovalStatus(logins, includeInvoiceNotPaidForAdmin, defaultStatus) {
    ...
    return logins
        ...
        if (status === ApprovalStatus.REGISTRATION_APPROVAL_NEEDED ||
...
export function getLoginErrorMessage(error, isExternalLogin) {
 ...
 */
export function handleExpectedLoginError(error, handler) {
...
export function getLoginErrorStateAndMessage(error) {
...
export async function showSignupDialog(urlParams) {
...
export function stringToSubscriptionType(string) {
...
function getSubscriptionParameters(hashParams) {
    ...
    if (!isSubscriptionString && !isTypeString && !isIntervalString)
        return null;
    return {
...
export function getReferralCodeFromParams(urlParams) {
    if (typeof urlParams.ref === "string") {
        return urlParams.ref;
    }
    return null;
}
export function getRegistrationDataIdFromParams(hashParams) {
...
export async function showGiftCardDialog(urlHash) {
...
export async function showRecoverDialog(mailAddress, resetAction) {
