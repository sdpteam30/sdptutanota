...
export class DesktopIntegratorLinux {
    ...
    async runIntegration(wm) {
        if (this.executablePath.includes("node_modules/electron/dist/electron"))
            return;
...
TryExec=${this.packagePath}`;
        return this._fs.promises
            ...
            .then(() => this._fs.promises.writeFile(this.desktopFilePath, desktopEntry, {
            encoding: "utf-8",
        }));
    }
    copyIcons() {
...
//# sourceMappingURL=DesktopIntegratorLinux.js.map