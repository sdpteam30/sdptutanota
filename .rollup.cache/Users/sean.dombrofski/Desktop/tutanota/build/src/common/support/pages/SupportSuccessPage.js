...
import { BlueskyLogo, MastodonLogo } from "../../gui/base/icons/Icons.js";
import { windowFacade } from "../../misc/WindowFacade.js";
import { lang } from "../../misc/LanguageViewModel.js";
export class SupportSuccessPage {
    view() {
        return m(".pt.pb", m(Card, { shouldDivide: true }, m(".plr", m(".h4.pb-s.pt-s", lang.get("supportSuccess_msg")), m("p.m-0", lang.get("supportSocialsInfo_msg")), m(".mt-l.mb-s", {}, m("img.block.full-width.height-100p", {
            ...
            rightIcon: { icon: "Open" /* Icons.Open */, title: "close_alt" },
            onclick: () => {
                windowFacade.openLink("https://tuta.com/blog");
            },
        }), m(SectionButton, {
            text: { text: "Mastodon", testId: "" },
            rightIcon: { icon: "Open" /* Icons.Open */, title: "open_action" },
            injectionLeft: m(".", {
                style: {
                    width: "24px",
                    height: "24px",
...
//# sourceMappingURL=SupportSuccessPage.js.map