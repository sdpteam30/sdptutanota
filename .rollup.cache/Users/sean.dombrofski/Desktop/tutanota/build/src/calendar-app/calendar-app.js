...
import("../mail-app/translations/en.js")
    ...
    if (isOfflineStorageAvailable()) {
        ...
        calendarLocator.logins.addPostLoginAction(async () => new CachePostLoginAction(await calendarLocator.calendarModel(), calendarLocator.entityClient, calendarLocator.progressTracker, calendarLocator.cacheStorage, calendarLocator.logins));
    }
        ...
        termination: makeViewResolver({
            prepareRoute: async () => {
                ...
                return {
                    ...
                    cache: {
                        makeViewModel: () => new TerminationViewModel(calendarLocator.logins, calendarLocator.secondFactorHandler, calendarLocator.serviceExecutor, calendarLocator.entityClient),
...
function makeViewResolver({ prepareRoute, prepareAttrs, requireLogin, }, logins) {
    ...
    return {
        ...
        render(vnode) {
            ...
            const attrs = { requestedPath, args, ...prepareAttrs(assertNotNull(cache)) };
            return m(root, m(c, {
                ...attrs,
                oncreate({ state }) {
...
function assignEnvPlatformId(urlQueryParams) {
...
function getStartUrl(urlQueryParams) {
...
//# sourceMappingURL=calendar-app.js.map