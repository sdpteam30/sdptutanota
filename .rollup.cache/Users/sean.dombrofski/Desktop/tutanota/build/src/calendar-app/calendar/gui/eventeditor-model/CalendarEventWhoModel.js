...
import { haveSameId } from "../../../../common/api/common/utils/EntityUtils.js";
import { cleanMailAddress, findRecipientWithAddress } from "../../../../common/api/common/utils/CommonCalendarUtils.js";
import { assertNotNull, clone, defer, findAll, noOp, trisectingDiff } from "@tutao/tutanota-utils";
...
export class CalendarEventWhoModel {
     ...
     */
    constructor(initialValues, eventType, operation, calendars, 
     ...
     * */
    _selectedCalendar, userController, isNew, ownMailAddresses, recipientsModel, responseTo, passwordStrengthModel, sendMailModelFactory, uiUpdateCallback = noOp) {
    ...
    get canModifyGuests() {
         ...
         **/
        const userIsOwner = this.eventType === "own" /* EventType.OWN */ && this.selectedCalendar.userIsOwner;
        return userIsOwner || !(this.selectedCalendar?.shared || this.eventType === "invite" /* EventType.INVITE */ || this.operation === 1 /* CalendarOperation.EditThis */);
    }
    /**
    ...
    getAvailableCalendars() {
        ...
        if (this.eventType === "locked" /* EventType.LOCKED */ || this.operation === 1 /* CalendarOperation.EditThis */) {
        ...
        else if (this._attendees.size > 0 && this.eventType === "own" /* EventType.OWN */) {
            return calendarArray.filter((calendarInfo) => calendarInfo.userIsOwner);
        }
        else if (this._attendees.size > 0 || this.eventType === "invite" /* EventType.INVITE */) {
            ...
            return calendarArray.filter((calendarInfo) => hasCapabilityOnGroup(this.userController.user, calendarInfo.group, "1" /* ShareCapability.Write */));
        }
    }
    ...
    async resolveAndCacheAddress(a) {
        if (this.resolvedRecipients.has(a.address))
            return;
    ...
    setupAttendees(initialValues) {
        ...
        const initialOrganizerAddress = initialValues.organizer == null
            ? null
        ...
        if (this.eventType === "own" /* EventType.OWN */ &&
            this._organizer != null &&
    ...
    get possibleOrganizers() {
        ...
        else if (this.eventType === "own" /* EventType.OWN */) {
            return this.ownMailAddresses;
        }
        else {
            // something is wrong.
    ...
    getGuestForAttendee(a) {
        if (this.resolvedRecipients.has(a.address.address)) {
            ...
            return {
                ...
                name: a.address.name,
                status: a.status,
                type: "unknown" /* RecipientType.UNKNOWN */,
                contact: null,
            };
        }
    }
    ...
    setOwnAttendance(status) {
        if (this._ownAttendee)
            this._ownAttendee.status = status;
    }
    ...
    hasInsecurePasswords() {
        ...
        for (const g of this._attendees.values()) {
            ...
            if (password === "" || isSecurePassword(strength))
                continue;
            return true;
        }
        return false;
    ...
    prepareResponseModel() {
        if (this.eventType !== "invite" /* EventType.INVITE */ || this._ownAttendee === null || this._organizer == null || this._ownAttendee == null) {
...
//# sourceMappingURL=CalendarEventWhoModel.js.map