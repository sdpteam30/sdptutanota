 ...
 */
export class CalendarEventPopup {
    model;
    eventBubbleRect;
    _shortcuts = [];
    ...
    constructor(model, eventBubbleRect, htmlSanitizer) {
        ...
        this.sanitizedDescription = prepareCalendarDescription(model.calendarEvent.description, (s) => htmlSanitizer.sanitizeHTML(convertTextToHtml(s), {
    ...
    renderEditButton() {
        if (!this.model.canEdit)
            return null;
        return m(IconButton, { title: "edit_action", icon: "Edit" /* Icons.Edit */, click: this.handleEditButtonClick });
    }
    renderDeleteButton() {
        if (!this.model.canDelete)
            return null;
        return m(IconButton, { title: "delete_action", icon: "Trash" /* Icons.Trash */, click: this.handleDeleteButtonClick });
    }
...
//# sourceMappingURL=CalendarEventPopup.js.map