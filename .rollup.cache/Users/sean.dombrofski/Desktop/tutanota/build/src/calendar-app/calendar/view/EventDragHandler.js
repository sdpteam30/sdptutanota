    ...
    async endDrag(dateUnderMouse, pos) {
        ...
        if (this.dragging && this.data) {
            ...
            const mode = repeatRule != null
                ...
                : recurrenceId != null
                    ? 1 /* CalendarOperation.EditThis */
                    : 3 /* CalendarOperation.EditAll */;
...
async function showModeSelectionDropdown(pos) {
    return new Promise((resolve) => {
        showDropdownAtPosition([
            { label: "updateOneCalendarEvent_action", click: () => resolve(1 /* CalendarOperation.EditThis */) },
            { label: "updateAllCalendarEvents_action", click: () => resolve(3 /* CalendarOperation.EditAll */) },
        ], pos.x, pos.y, () => resolve(null));
    });
}
//# sourceMappingURL=EventDragHandler.js.map