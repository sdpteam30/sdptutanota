import { getAllDayDateUTC, getEventWithDefaultTimes, isAllDayEvent } from "../../../../common/api/common/utils/CommonCalendarUtils.js";
import { Time } from "../../../../common/calendar/date/Time.js";
import { DateTime } from "luxon";
import { areExcludedDatesEqual, areRepeatRulesEqual, getAllDayDateUTCFromZone, getEventEnd, getEventStart, getRepeatEndTimeForDisplay, getStartOfDayWithZone, getStartOfNextDayWithZone, incrementByRepeatPeriod, } from "../../../../common/calendar/date/CalendarUtils.js";
...
export class CalendarEventWhenModel {
     ...
     */
    get repeatEndType() {
        return (this.repeatRule?.endType ?? "0" /* EndType.Never */);
    }
    /**
    ...
    get repeatEndOccurrences() {
        if (this.repeatRule?.endType === "1" /* EndType.Count */ && this.repeatRule?.endValue) {
    ...
    set repeatEndOccurrences(endValue) {
        ...
        if (this.repeatRule && this.repeatRule.endType === "1" /* EndType.Count */ && this.repeatRule.endValue !== stringEndValue) {
    ...
    get repeatEndDateForDisplay() {
        if (this.repeatRule?.endType === "2" /* EndType.UntilDate */) {
    ...
    set repeatEndDateForDisplay(newRepeatEndDate) {
        if (this.repeatRule == null || this.repeatRule.endType !== "2" /* EndType.UntilDate */) {
            return;
        }
 ...
 */
export function getDefaultEndDateEndValue({ startTime }, timeZone) {
 ...
 */
export function getDefaultEndCountValue() {
    return "10";
}
export function repeatRuleWithExcludedAlteredInstances(progenitor, recurrenceIds, timeZone) {
...
//# sourceMappingURL=CalendarEventWhenModel.js.map