...
import { isKeyPressed, keyboardEventToKeyPress, useKeyHandler } from "../../../../common/misc/KeyManager.js";
import { Keys } from "../../../../common/api/common/TutanotaConstants.js";
import { isApp } from "../../../../common/api/common/Env.js";
import { InputButton, InputButtonVariant } from "../../../../common/gui/base/InputButton.js";
export var PickerPosition;
(function (PickerPosition) {
    PickerPosition[PickerPosition["TOP"] = 0] = "TOP";
    PickerPosition[PickerPosition["BOTTOM"] = 1] = "BOTTOM";
...
export class DatePicker {
    ...
    renderInputButtonPicker({ disabled, date, onDateSelected, label }) {
        return m.fragment({}, [
            isApp()
                ...
                : null,
            m(InputButton, {
                tabIndex: Number(isApp() ? "-1" /* TabIndex.Programmatic */ : "0" /* TabIndex.Default */),
    ...
    renderTextField({ date, onDateSelected, label, nullSelectionText, disabled }) {
        return m("", {
            ...
            disabled,
            hasPopup: "dialog" /* AriaPopupType.Dialog */,
            oninput: (text) => {
    ...
    renderDropdown({ date, onDateSelected, startOfTheWeekOffset, rightAlignDropdown, label, position }) {
        ...
        return m(".content-bg.z3.menu-shadow.plr.pb-s", {
            "aria-modal": "true",
...
export class VisualDatePicker {
    ...
    view(vnode) {
        ...
        return m(".flex.flex-column", {
            onkeydown: (event) => useKeyHandler(event, vnode.attrs.keyHandler),
        }, [
    ...
    renderDay({ date, day, isPaddingDay }, index, attrs) {
        ...
        return m(".rel.flex.items-center.justify-center", {
            style: {
                height: px(size),
                width: px(size),
            },
            ...
            role: "option",
            tabindex: isTabbable ? "0" /* TabIndex.Default */ : "-1" /* TabIndex.Programmatic */,
    ...
    renderWeek(week, attrs) {
        return m(".flex.flex-space-between", week.map((d, i) => this.renderDay(d, i, attrs)));
    }
