 ...
 */
export function showDateRangeSelectionDialog(startOfTheWeekOffset, start, end, dateValidator = () => null) {
    const helpLabel = (date) => date != null ? lang.makeTranslation("date", formatDateWithWeekdayAndYear(date)) : lang.getTranslation("unlimited_label");
    ...
    let warning = null;
    const form = {
        view: () => m(".flex.col", m(".flex-space-between", [
