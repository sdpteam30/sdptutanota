...
export class GuestPicker {
    ...
    renderSuggestionItem(selected, option) {
        const firstRow = option.value.type === "recipient"
        ...
        return m(".pt-s.pb-s.click.content-hover.button-min-height", {
    ...
    closePicker() {
        if (this.selectDOM) {
            ;
            this.selectDOM.state.dropdownContainer?.onClose();
        }
    }
}
//# sourceMappingURL=GuestPicker.js.map